...
public final class NoisyApproximateSetSfmFromIndexAndZerosAggregationDefaultBucketsPrecision
{
    private NoisyApproximateSetSfmFromIndexAndZerosAggregationDefaultBucketsPrecision() {}
    ...
    {
        addIndexAndZerosToSketch(state, index, nzeros, epsilon, DEFAULT_BUCKET_COUNT, DEFAULT_PRECISION);
    }
